...
export function ChoiceQuiz({ lang, category, onBack, onCorrect }: Props) {
  ...
  return (
    <section className="panel">
      ...
      <div className="prompt-card">
        ...
        <h1>{round.answer.english}</h1>
        <p className="lede">{t(lang, 'question')}</p>
        <SpeakButton text={round.answer.hanzi} lang={lang} />
      </div>
