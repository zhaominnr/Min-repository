...
const copy = {
  ...
  practiceTalk: { en: 'Practice Talk', zh: '练习对话' },
  practiceTalkHint: { en: 'Speak a short dialogue. No key needed.', zh: '练习短对话。不需要密钥。' },
  pandaSays: { en: 'Panda says', zh: '熊猫说' },
  youSay: { en: 'You say', zh: '你说' },
  iSaidIt: { en: 'I said it', zh: '我说了' },
  whatNext: { en: 'What do you say next?', zh: '接下来你说什么？' },
  dialogueDone: { en: 'You finished this talk.', zh: '这段对话完成了。' },
  dialogueDoneShort: { en: 'Done', zh: '完成' },
  startTalk: { en: 'Start', zh: '开始' },
  talksDone: { en: 'Talks done', zh: '完成的对话' },
  talk: { en: 'AI Talk', zh: 'AI对话' },
  talkHint: { en: 'Chat with an AI tutor. Needs a parent key.', zh: '和AI老师聊天。需要家长密钥。' },
  talkEmpty: {
    en: 'AI Talk needs an API key. A parent can add it in Settings.',
    zh: 'AI对话需要密钥。家长可以在设置里填写。',
  },
  ...
  parentsBody4: {
    en: 'Practice Talk needs no key. You can use it with no internet. AI Talk needs a parent API key. That key stays in this browser on this device. Anyone who uses this device can see it. Use AI Talk at home only. Do not put the key in the app files.',
    zh: '练习对话不需要密钥。没有网络也能用。AI对话需要家长填写密钥。密钥只留在这台设备的浏览器里。用这台设备的人都能看到它。请只在家里用AI对话。不要把密钥写进应用文件。',
  },
